function convertirTodos(){
    ...
    let primeros3Numeros = document.getElementById('primeros3Numeros').value;
    ...
    if(primeros3Numeros < 0 || segundos3Numeros < 0 || terceros3Numeros < 0 || cuartos3Numeros < 0){
        ...
        alert('NO HAY NADA EN ALGUNA DE ESTAS COSAS');
        document.getElementById('resultadoIp').value = '';
        ...
        alert('NO EXISTEN VALORES PARA ESA IP');
        document.getElementById('resultadoIp').value = '';
        ...
        let datos = (separador(ipTexto).split(','));
